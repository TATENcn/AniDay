  ...
  return (
    <>
      ...
      <div className="flex flex-col h-screen relative text-white z-50 md:w-lg lg:w-xl xl:w-2xl 2xl:w-4xl mx-auto gap-4 p-4">
        ...
        <div
          className="my-auto transition-opacity duration-500 ease-in-out"
        ...
        >
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="text-md flex gap-2 text-neutral-300">
              <span>
                {String(characters[currentIndex]!.birthday.month).padStart(
                  2,
                  "0"
                )}
              </span>
              <span>/</span>
              <span>
                {String(characters[currentIndex]!.birthday.day).padStart(
                  2,
                  "0"
                )}
              </span>
